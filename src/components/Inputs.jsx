...
function Inputs({setQuery,units,setUnits}) {
  ...
  return (
    <div className='flex flex-row justify-between my-6 '>
      <div className='flex flex-row items-center w-34 justify-center space-x-4 '>
      ...
      <div className='flex flex-row items-center justify-center gap-3 w-1/4 text-xl text-white'>
